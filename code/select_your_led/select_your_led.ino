...
void loop() {
  prenderLed(0, 0);  // Prender LED en columna 5, fila 10
  delay(500);
  apagarLed(0, 0);  // Apagar el mismo LED
  delay(500);

  prenderLed(0, 17);  // Prender LED en columna 5, fila 10
  delay(500);
  apagarLed(0, 17);  // Apagar el mismo LED
  delay(500);

  prenderLed(23, 0);  // Prender LED en columna 5, fila 10
  delay(500);
  apagarLed(23, 0);  // Apagar el mismo LED
  delay(500);


  prenderLed(23, 17);  // Prender LED en columna 5, fila 10
  delay(500);
  apagarLed(23, 17);  // Apagar el mismo LED
  delay(500);
}
